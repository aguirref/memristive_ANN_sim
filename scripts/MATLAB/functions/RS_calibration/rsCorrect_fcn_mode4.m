...
%   Detailed explanation goes here
    ...
    for cal_criterion_i=1:length(cal_criterion_vec)
        ...
        save(fullfile(directory2,'compensation_variables.mat'),'G_trasp','RHRS','RLRS','Rs','accuracy_calc','calibrate','cal_criterion','V_read','cant_muestras','partitions','cal_vector','images_t10k','labels_t10k','output_side','directory');
